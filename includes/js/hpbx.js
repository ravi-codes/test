(function ($) {
  ...
  $('document').ready(function() {
	  ...
	  if($('#edit-table-alias-number-value').find('option:selected').text()==Drupal.t('None')){
    ...
    //issue fix #9351 - Fax log pagination not working.
    ...
    $(document).on("edit-subscriber-general-number-change", function(event, element) {
      ...
      if($(element).find('option:selected').text()==Drupal.t('None') && (form_id=='hpbx_autoattendant_edit_form' || form_id=='hpbx_huntgroup_edit_form' || form_id=='hpbx_conference_edit_form')){
    	  $('#caller_line_identification').show();
      }else if($(element).find('option:selected').text()!=Drupal.t('None') && (form_id=='hpbx_autoattendant_edit_form' || form_id=='hpbx_huntgroup_edit_form' || form_id=='hpbx_conference_edit_form')){
    	  $('#caller_line_identification').hide();
      }
      ...
      if (extension_from_did) {
        ...
        else if ($(element).find('option:selected').text()==Drupal.t('None')){
        	if(form_id=='hpbx_subscriber_edit_form'){
