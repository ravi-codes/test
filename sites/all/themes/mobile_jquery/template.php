...
function mobile_jquery_preprocess_html(&$vars) {
  ...
  if (module_exists('jquerymobile')) {
    ...
    drupal_add_css(drupal_get_path('theme', 'mobile_jquery') . '/jquery.mobile.structure-1.3.0.css', array_merge($css_options, array('weight' => 100)));
    drupal_add_css(drupal_get_path('theme', 'mobile_jquery') . '/jquery.mobile-1.3.0.css', array_merge($css_options, array('weight' => 100)));
    //drupal_add_js('http://code.jquery.com/jquery-1.6.4.min.js', array_merge($js_options, array('weight' => 100)));
    drupal_add_js(drupal_get_path('theme', 'mobile_jquery') . '/scripts/mobile_jquery.js', array_merge($js_options, array('weight' => 102)));
    drupal_add_js(drupal_get_path('theme', 'mobile_jquery') . '/scripts/jquery.mobile-1.3.0.js', array_merge($js_options, array('weight' => 101)));
  }
...
function mobile_jquery_preprocess_page(&$vars) {
  ...
  $vars['page']['attributes_array']['header']['data-tap-toggle'] = "false";
