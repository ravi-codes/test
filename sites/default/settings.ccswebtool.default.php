 ...
 *
 */
$drupal_hash_salt = '-12n3iSCWy0as0gNgXV7V8dvJuUGkZf4SLaA5boL-yY';
...
/*
 * ADM soap confguration options.
 */
//$conf['adm_soap']['wsdl'] = 'http://admprov-a.netops.local:8080/index.php?WSDL';
$conf['adm_soap']['wsdl'] = 'http://admprovisioning.local/index.php?WSDL';
$conf['adm_soap']['user'] = '<fill user>';
$conf['adm_soap']['pass'] = '<fill password>';
$conf['adm_soap']['options'] = array(
//	'uri' => 'http://admprov-a.netops.local:8080/',
//	'location' => 'http://admprov-a.netops.local:8080/index.php',
       'uri' => 'http://admprovisioning.local/',
       'location' => 'http://admprovisioning.local/index.php',
       'trace' => TRUE,
       'exceptions' => TRUE,
