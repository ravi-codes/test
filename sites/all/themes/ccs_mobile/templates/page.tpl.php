 ...
 */
?>
<div data-role="page" <?php print drupal_attributes($page['attributes_array']['page']); ?>>
  
    <div class="header" <?php print drupal_attributes($page['attributes_array']['header']); ?>>
      <a href="#panel-sidebar-first" data-shadow="false" data-icon-shadow="false" data-role="button" data-rel="dialog" data-corners="false" data-transition="pop" data-icon="sidebar-first">&nbsp;</a>
      ...
      <?php if (isset($page['right-button'])): print $page['right-button'];endif;?>
      
    </div> <!-- /#header -->

    <?php if ($page['sidebar_first']): ?>
      <div data-role="panel" id="panel-sidebar-first">
    ...
    <div class="main-content" <?php print drupal_attributes($page['attributes_array']['content']); ?>>
        ...
        <div data-role="content" role="main" class="content-primary">
